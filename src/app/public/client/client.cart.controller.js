...
(function () {
    ...
    /*@ngNoInject*/
    function ClientCartController($state, $rootScope,$scope,$timeout,ClientCartService,ClientService, uiDatetimePickerConfig, $translate, moment, appConstant, RestaurantDetailService) {
        var vm = this;
        vm.show = true;
        debugger;
                ...
                angular.forEach(vm.orderDetail, function(side_dish) {
                    if(side_dish.side_dish == order.ID_orders_detail) {
                        ...
                        if (side_dish.is_child){
                            side_dish.t_price = (side_dish.menu_list.data.price_child ? side_dish.menu_list.data.price_child :side_dish.menu_list.data.price ) * side_dish.x_number;
                        } else {
